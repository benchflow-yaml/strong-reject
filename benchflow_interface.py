#!/usr/bin/env python3
# BenchFlow Interface for StrongREJECT
# This file is a template for integrating StrongREJECT with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading StrongREJECT benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "github": "https://github.com/anthropics/evals/tree/main/evals/elsuite/strong_reject",
            "paper": "",
            "website": ""
        }
